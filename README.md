...
| Метрика                      | CustomThreadPool | ThreadPoolExecutor | ForkJoinPool |
|------------------------------|------------------|--------------------|--------------|
| Время выполнения (мс)        | 196              | 177                | 222          |
| Выполнено задач              | 96               | 88                 | 100          |
| Отклонено задач              | 4                | 12                 | 0            |

200 задач sleep(10ms):

| Метрика                      | CustomThreadPool | ThreadPoolExecutor | ForkJoinPool |
|------------------------------|------------------|--------------------|--------------|
| Время выполнения (мс)        | 216              | 207                | 371          |
| Выполнено задач              | ~110             | ~96                | 200          |
| Отклонено задач              | ~90              | ~104               | 0            |

100 задач sleep(1000s):

| Метрика                      | CustomThreadPool | ThreadPoolExecutor | ForkJoinPool |
|------------------------------|------------------|--------------------|--------------|
| Время выполнения (мс)        | 11104-11127      | 11106-11142        | 13118-13133  |
| Выполнено задач              | 88               | 88                 | 100          |
| Отклонено задач              | 12               | 12                 | 0            |
